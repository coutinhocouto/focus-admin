...
<div class="col-md-12">
	...
	<?php if($up) { ?>
		<div class="alert alert-success alert-icon-block alert-dismissible" role="alert">
			...
			<strong>Sucesso!</strong> Locador criado/alterado com sucesso! 
	...
	<?php if($del) { ?>
		<div class="alert alert-danger alert-icon-block alert-dismissible" role="alert"> 
			...
			<strong>Alerta!</strong> Seu locador foi removido! 
			<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span class="fa fa-times"></span></button>
		</div>
	<?php } ?>
		...
		<tbody>
			...
			?>
					...
					<tr>
						...
						<td>
							<a href="https://focusadministradora.com/rentals/locadores/ver-locador/?pid=<?php echo get_the_ID();?>"><button type="button" class="btn btn-default btn-icon"><span class="fa fa-eye"></span></button></a>
							<a href="https://focusadministradora.com/rentals/locadores/editar-locador/?pid=<?php echo get_the_ID();?>"><button type="button" class="btn btn-default btn-icon"><span class="icon-pencil"></button></a>
